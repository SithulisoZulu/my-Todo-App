...
var notasks_page_1 = require("src/app/bottomsheets/notasks/notasks.page");
var TasksPage = /** @class */ (function () {
    function TasksPage(router, db, ModalCtrl) {
        this.router = router;
        this.db = db;
    ...
    TasksPage.prototype.notasks = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ModalCtrl.create({
                            component: notasks_page_1.NotasksPage,
                            breakpoints: [0, 0.3],
    ...
    TasksPage.prototype.getuser = function () {
        var _this = this;
        this.db
    ...
    TasksPage.prototype.navigate = function (task) {
